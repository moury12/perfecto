...
import '../../../product-details/review/write_review_page.dart';
    ...
    return GestureDetector(
      ...
      child: Stack(
        children: [
          ...
          if (order.status == '4' && orderDetails.first.combo == null)
            Positioned(
                child: GestureDetector(
                  onTap: () async {
                    await ProductDetailsController.to.getProductDetails(orderDetails.first.productId!);
