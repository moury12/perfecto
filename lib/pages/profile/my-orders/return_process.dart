                      ...
                      return Column(
                        ...
                        children: [
                          Padding(
                            ...
                            child: Row(
                              children: [
                                ...
                                const Spacer(),
                            cancel=='cancel'? SizedBox.shrink():   Row(
                          ...
                          const Divider(
                            ...
                            child: Column(crossAxisAlignment:CrossAxisAlignment.start,children: [Text(  cancel=='cancel'?'Order cancel successfully':'Your return ID is: #6268716eagfg66',style: AppTheme.textStyleSemiBoldBlack14,),Text('You will receive an return confirmation email with details.',style: AppTheme.textStyleSemiBoldfadeBlack12,),],),
                          ),
                          StepProcessWidget(currentStep:cancel=='cancel'?ProfileController.to.currentStepForCancel.value:ProfileController.to.currentStepForReturn.value ,processList:cancel=='cancel'?ProfileController.to.cancelProcesses: ProfileController.to.Returnprocesses),


                          cancel=='cancel'?SizedBox.shrink():  Padding(
                            padding: const EdgeInsets.symmetric(
                                horizontal: 16, vertical: 12),
                            child: Column(
                              crossAxisAlignment: CrossAxisAlignment.start,
                              children: [
                                CustomDividerWidget(),CustomSizedBox.space12H,
                                Text(
                                  'Return Method',
