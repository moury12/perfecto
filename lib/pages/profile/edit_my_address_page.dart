...
//                                   color: addressModel!.status == '1' ? AppColors.kPrimaryColor : Colors.white,
//                                   border: Border.all(width: 0.5, color: addressModel!.status == '1' ? AppColors.kDarkPrimaryColor : Colors.black.withOpacity(.25))),
