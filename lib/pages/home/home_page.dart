           ...
           child: ListView(
             ...
             children: [
               ...
               Padding(
                 ...
                 child: Container(margin: EdgeInsets.symmetric(horizontal: 8),
                   decoration: BoxDecoration(
                   borderRadius: BorderRadius.circular(10),
                     boxShadow: [BoxShadow(color: Colors.black.withOpacity(.25),blurRadius: 4)]),
                   child: CustomNetworkImage(networkImagePath: '',errorImagePath: AssetsConstant.slider1,
                       width: double.infinity,
                       fit: BoxFit.fill,borderRadius: 10,),
                 )
               ),
               ...
               GridItemWidget(
                 size: size,
                 img: AssetsConstant.megaDealsBackground,data: HomeController.to.megadealsITem,
               ),
               ...
               GridItemWidget(data: HomeController.to.megadealsITem,
