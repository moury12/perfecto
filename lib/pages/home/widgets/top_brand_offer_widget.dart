...
class BestSellerListWidget extends StatelessWidget {
  ...
  const BestSellerListWidget({
    super.key,  this.isBestSeller= true,
  });
                  ...
                  children: [
                    ...
                    Positioned(
                      ...
                      child: Container(
                          ...
                          decoration: const BoxDecoration(color: Color(0xffFFF2D9),borderRadius: BorderRadius.only(topRight: Radius.circular(4),bottomRight: Radius.circular(4)),
                          ),
                          child: Row(children: [
                            Icon(Icons.star_rate_rounded,color: AppColors.kOfferButtonColor,size: 15,), RichText(text: TextSpan(text: '',style: AppTheme.textStyleBoldBlack14, children: [
                              TextSpan(text: '4.4',style: AppTheme.textStyleBoldBlack10,),
                              TextSpan(text: ' | ',style: AppTheme.textStyleNormalFadeBlack12,),TextSpan(text: '(255)',style: const TextStyle(color: Colors.black54,fontSize: 8, fontWeight: FontWeight.bold),)
                            ])),
                          ],)),
                    )
                  ],
...
class SegmentGridWidget extends StatelessWidget {
  ...
  const SegmentGridWidget({
    super.key, this.blueBackground, this.img, this.widgetinBlueShade, this.networkImg,
  });
