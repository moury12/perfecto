        ...
        children: [
          ...
          Container(
            decoration: BoxDecoration(
              border: Border(
                  bottom: BorderSide(color: Color(0xffECECEC), width: 1.5)),
            ),
            child: TabBar(
                isScrollable: true,
                ...
                SizedBox(
                  ...
                  child: TabBarView(
                      ...
                      children: List.generate(
                          ProductDetailsController.to.tabTiles2.length, (index) {
        ...
        return Padding(
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [CustomSizedBox.space12H,
                  Column(children: List.generate(5, (index) =>
                  CustomNetworkImage(networkImagePath: '',borderRadius: 0,
                    errorImagePath: 'assets/discription.png',width: double.infinity,
                    height: 200,
                  )),),CustomSizedBox.space12H,
                  Text('Lorem ipsum dolor sit amet consectetur. Elementum neque est bibendum quis. Sed vitae curabitur elementum felis urna sed sed diam. Arcu tempor ullamcorper viverra morbi venenatis amet donec in maecenas. Lorem ipsum dolor sit amet consectetur. Elementum neque est bibendum quis. Sed vitae curabitur elementum felis urna sed sed diam. Arcu tempor ullamcorper viverra morbi venenatis amet donec in maecenas.',style: AppTheme.textStyleNormalBlack14,),CustomSizedBox.space12H,
                  Text('Expiry Date: 15 May 2025',style: AppTheme.textStyleBoldBlack14,),CustomSizedBox.space12H, Text('Country of Origin: India',style: AppTheme.textStyleBoldBlack14,),CustomSizedBox.space12H,CustomSizedBox.space12H, Text('Manufacturer: Hindustan Unilever Ltd.',style: AppTheme.textStyleBoldBlack14,),CustomSizedBox.space12H, Text('Address: Unit Ii - Haridwar',style: AppTheme.textStyleBoldBlack14,),CustomSizedBox.space12H,
                ],
              ),
            ));
      case 1:
        return Padding(
          ...
          child: Text('Ethylhexyl Palmitate, Sorbeth-30 Tetraoleate, Caprylic/Capric Triglyceride, Polyethylene, Lavandula Angustifolia (Lavender) Oil, Helianthus Annuus (Sunflower) Seed Oil, Eucalyptus Globulus Leaf Oil, Caprylyl Glycol, Ethylhexylglycerin, Anthemis Nobilis Flower Oil, Avena Sativa (Oat) Kernel Oil, Butyrospermum Parkii (Shea) Butter, Cocos Nucifera (Coconut) Oil, Olea Europaea (Olive) Fruit Oil, Oenothera Biennis (Evening Primrose) Oil, Persea Gratissima (Avocado) Oil, Prunus Amygdalus Dulcis (Sweet Almond) Oil, Simmondsia Chinensis (Jojoba) Seed Oil, Water, 1,2-Hexanediol, Centella Asiatica Extract, Centella Asiatica Leaf Extract, Centella Asiatica Root Extract, Pinus Pinaster Bark Extract, Asiaticoside, Asiatic Acid, Madecassoside, Madecassic Acid',style: AppTheme.textStyleSemiBoldBlack14,),
        );   case 2:
      return Padding(
        padding: const EdgeInsets.all(16.0),
        child: Text('Ethylhexyl Palmitate, Sorbeth-30 Tetraoleate, Caprylic/Capric Triglyceride, Polyethylene, Lavandula Angustifolia (Lavender) Oil, Helianthus Annuus (Sunflower) Seed Oil, Eucalyptus Globulus Leaf Oil, Caprylyl Glycol, Ethylhexylglycerin, Anthemis Nobilis Flower Oil, Avena Sativa (Oat) Kernel Oil, Butyrospermum Parkii (Shea) Butter, Cocos Nucifera (Coconut) Oil, Olea Europaea (Olive) Fruit Oil, Oenothera Biennis (Evening Primrose) Oil, Persea Gratissima (Avocado) Oil, Prunus Amygdalus Dulcis (Sweet Almond) Oil, Simmondsia Chinensis (Jojoba) Seed Oil, Water, 1,2-Hexanediol, Centella Asiatica Extract, Centella Asiatica Leaf Extract, Centella Asiatica Root Extract, Pinus Pinaster Bark Extract, Asiaticoside, Asiatic Acid, Madecassoside, Madecassic Acid',style: AppTheme.textStyleSemiBoldBlack14,),
