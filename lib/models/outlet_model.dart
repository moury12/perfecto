class OutletModel {
  ...
  OutletModel({this.id, this.name, this.email, this.address, this.mobile, this.logo, this.latitude, this.longitude, this.defaultAddress, this.status, this.createdAt, this.updatedAt});
