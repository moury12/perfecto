...
class BrandModel with ISuspensionBean {
  ...
  BrandModel.fromJson(Map<String, dynamic> json) {
    ...
    isPopular = json['is_popular'].toString() == 'null'
        ? ''
        : json['is_popular'].toString();
    isTopBrand = json['is_top_brand'].toString() == 'null'
        ? ''
        : json['is_top_brand'].toString();
  }
...
class CategoryModel {
  ...
  CategoryModel.fromJson(Map<String, dynamic> json) {
    ...
    name = json['name'].toString() == 'null' ? '' : json['name'].toString();
    image = json['image'].toString() == 'null' ? '' : json['image'].toString();
    productsCount = json['products_count'].toString() == 'null'
        ? ''
        : json['products_count'].toString();

    status =
        json['status'].toString() == 'null' ? '' : json['status'].toString();
    parentId = json['parent_id'].toString() == 'null'
        ? ''
